...
use App\Observers\IndicatorSuccessObserver;
...
class IndicatorSuccess extends Model
{
    use HasCurrency;
    use HasFactory;
    ...
    {
        parent::boot();
        self::observe(IndicatorSuccessObserver::class);
    }
    ...
    {
        return $this->belongsToMany(Programme::class, 'indicator_success_programme')->withPivot('status');
    }
